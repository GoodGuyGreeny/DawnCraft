...
1) Install Forge 1.18.2 - 40.2.17 on your server:
...
6) It's recommended to start a NEW world if you are updating from 1.xxx to 2.xxx due to improved world generation, new quests, structures, etc... 

7) If you're using BisectHosting service, a pre-generated world should already be provided if you select "DawnCraft - Echoes of Legends" as your jar file :)

8) For issues/crashes/bugs, go to our patreon discord channel for help:
